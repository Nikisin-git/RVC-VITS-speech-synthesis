...
Описание процедуры развертывания проекта на локальной машине, процедура миграции на локальные сервера,
быстрый запуск приложения, процедура подготовки окружения к работе, а также системные требования для стабильной работы приложения
вынесены в отдельный документ: [Deployment.md](Deployment.md).

---

## 6. Разработанные экранные формы
...
## 7. Демонстрация и сравнение отрезков синтезированной речи

🔊 **[Прослушать сравнение чекпоинтов TTS](https://nikisin-git.github.io/RVC-VITS-speech-synthesis/tts_comparison.html)** — страница с аудиопримерами всех сохранённых чекпоинтов и метриками (открывается через GitHub Pages).
